...
//
// Balancing: `−2 PA`. Doubling swing count is a large raw-output lever,
// so the accessory pays a flat Power tax. The −2 composes at the
// equipment tier (additive), *before* multiplicative passives like Two
// Weapons' PA × 0.75, so a Two-Weapons Assassin pays the −2 first and
// then the × 0.75 — a deliberately steep trade for four swings.
