...
//
// Charged tile-anchored AoE magical fire damage. Base shape is `cross r1`
// (5 tiles); when the caster has Aether Bloom equipped (free for Fire
// Mage), `modifyAoeShape` enlarges to `cross r2` (9 tiles) per ADR-0031.
...
//   - shape cross r1 (base); Aether Bloom enlarges to cross r2
