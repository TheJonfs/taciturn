# ADR-0141: TABA chapter-1 plot-unit seams (chapter context, cover, unit-restricted components)

**Status:** Accepted (three seams shipped; five unit instantiations deferred to the next session)
**Date:** 2026-07-05
**Session:** S84
