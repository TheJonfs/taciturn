...
Elevation convention (universal; ADR-0073): **0** deep water (3 MP), **1** shallow water (2 MP), **≥2** land. **8 = building wall** — the `roof` terrain (S100 shingle art; previously `rampart`), jump-impassable by height.
