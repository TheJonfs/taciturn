...
- ~~Campaign / between-battle progression~~ — **now the active TABA expansion
  ...
  graph + M1.5 story-scenes (battle-as-beat) shipped; **M2 progression
  effectively complete** (stat curves ADR-0137; JP economy ADR-0138 — per-class
  ...
  **Map substrate for M4 (S96–98):** the two Ch1 story maps (Oskun Fields,
  ...
  by authoring and fighting on a fresh map end-to-end. The enemy-placement
